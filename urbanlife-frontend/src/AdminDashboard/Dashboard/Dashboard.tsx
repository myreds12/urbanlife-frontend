...
import './dashboard.css'; // Pastikan file ini ada di src/
import { Link } from 'react-router-dom';
import Calendar from 'react-calendar'; // Tambah kalender
import './CalendarCustom.css'; // Styling default kalender
  ...
  return (
    <div className="p-2">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
        {/* Bagian kiri: 4 widget chart (2x2 di mobile/tablet) */}
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeWidth="2"
                      d={widget.trend === 'up' ? 'M5 13V1m0 0L1 5m4-4 4 4' : 'M5 1v12m0 0L9 7m-4 4-4-4'}
                    />
                  </svg>
                </div>
              </div>
        ...
        {/* Bagian kanan: Widget kalender */}
        <div className="lg:col-span-1">
          <div className="w-full p-1 rounded-lg">
            <h5 className="text-2xl font-bold text-gray-900 mb-5">Calendar upcoming event</h5>
            <Calendar
              value={new Date()} // Tanggal default hari ini
              className="react-calendar" // Custom class buat styling
              tileClassName={({ date, view }) => {
                if (view === 'month' && date.getDate() === 17) {
                  return 'highlight'; // Highlight tanggal 17 kayak gambar
                }
                return null;
              }}
            />
