...
import AirportGrid from "./Airport/AirportGrid";
    ...
    <div className="categories-page">
      ...
      >
        ...
        <div className="hero-content">
          <h1 className="hero-title playfair">{t("airport.airportpackage")}</h1>
          <div className="breadcrumb">
            ...
            <span>{t("airport.airportpackage")}</span>
          </div>
        </div>
      </div>
