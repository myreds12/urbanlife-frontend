    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
          <div className="inline-flex items-center px-4 py-2 bg-cyan-100 rounded-full text-cyan-700 text-sm font-medium mb-6">
            ...
            {dummyData.custom.map((item) => (
              ...
              >
                <div className="flex items-start space-x-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-semibold text-gray-900 mb-2">{item.title_en}</h2>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200 space-y-5">
                  <p className="text-gray-700 text-base leading-relaxed">{item.content_en}</p>

                  {item.notes.length > 0 && (
                    <div className="bg-cyan-50/70 rounded-xl p-4">
                      <h4 className="font-semibold text-gray-900 mb-2 text-md">Notes</h4>
                      <ul className="text-gray-700 text-sm space-y-2 ml-4 list-disc">
