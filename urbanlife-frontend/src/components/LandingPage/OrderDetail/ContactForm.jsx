...
const FlagIcon = ({ countryCode, className = "w-6 h-4" }) => {
  ...
  return <div className={`${className} rounded-sm border border-gray-300`} style={{ background: '#ccc' }} />;
};
...
const ContactForm = ({ formData, onFormChange }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Phone Number with Custom Country Picker */}
        ...
        <div className="flex items-center">
          <div className="relative">
            <button
              ...
              className="h-12 px-2 py-3 bg-white border border-gray-300 rounded-l-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 text-sm flex items-center"
            >
              <FlagIcon countryCode={selectedCountry.flag} className="w-8 h-5 mr-2" />
            ...
            {isOpen && (
              <div className="absolute z-10 mt-1 w-32 bg-white border border-gray-300 rounded-lg shadow-lg">
                {countryOptions.map((country) => (
                  ...
                  >
                    <FlagIcon countryCode={country.flag} className="w-8 h-5 mr-2" />
                    {country.code}
                  </button>
                ))}
              </div>
          ...
          <input
            ...
            className="w-full pl-4 pr-4 py-3 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-colors"
          />
        </div>
      </div>
