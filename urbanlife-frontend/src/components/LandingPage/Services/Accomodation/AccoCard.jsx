      ...
      <div className="acco-card">
        ...
        <div className="card-bottom">
          <div className="stars-container">
            <img src="/images/LandingPage/Footer/star.png" alt="star" className="star-small" />
            <img src="/images/LandingPage/Footer/star.png" alt="star" className="star-medium" />
            <img src="/images/LandingPage/Footer/star.png" alt="star" className="star-large" />
          </div>
