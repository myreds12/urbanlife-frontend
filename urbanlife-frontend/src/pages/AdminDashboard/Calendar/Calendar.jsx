...
const Calendar = () => {
  ...
  return (
    <>
      <PageMeta title="React.js Calendar Dashboard" description="Calendar Dashboard Page" />
        ...
        <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] p-6 lg:p-10">
          <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
                  ...
                  {Object.keys(calendarsEvents).map((key) => (
                    <label key={key} className="flex items-center text-sm text-gray-700 dark:text-gray-400">
                      <input
                        ...
                        className="sr-only"
                      />
                      <span className="w-5 h-5 mr-2 border border-gray-300 rounded-full flex items-center justify-center">
                        <span
            ...
            <div className="flex items-center gap-3 mt-6 sm:justify-end">
              <button
                onClick={closeModal}
                className="w-full sm:w-auto rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
              >
                Close
              </button>
              <button
