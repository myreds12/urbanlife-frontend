      ...
      <div className="bg-white p-6 rounded-lg shadow-md shadow-black/20">
        <div className="mb-4 flex items-center justify-between">
          ...
          <input
            ...
            required
            placeholder="e.g. Terms of Use, User Obligations"
          />
          <button
            type="button"
            onClick={onRemove}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="bg-gray-50 p-5 rounded-xl border border-gray-200">
            ...
            <div className="space-y-4">
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Terms and Conditions Content (EN) <span className="text-red-500">*</span>
              </label>
                  ...
                  <RichTextPlugin
                    ...
                    placeholder={
                      <div className="absolute top-3 left-3 text-gray-400 pointer-events-none">
                        Enter Terms and Conditions content in English...
                      </div>
                    }
          ...
          <div className="bg-gray-50 p-5 rounded-xl border border-gray-200">
            ...
            <div className="space-y-4">
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Terms and Conditions Content (ID) <span className="text-red-500">*</span>
              </label>
              <LexicalErrorBoundary>
                <LexicalComposer
                  initialConfig={{
                ...
                >
                  ...
                  <RichTextPlugin
                    ...
                    placeholder={
                      <div className="absolute top-3 left-3 text-gray-400 pointer-events-none">
                        Masukkan konten Terms and Conditions dalam bahasa Indonesia...
                      </div>
                    }
