    ...
    <div className="p-2">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
        ...
        <div className="lg:col-span-1">
          ...
          {/* Tambahan Widget di Bawah Calendar */}
          <div className="mt-4 space-y-2">
            <div className="bg-green-100 rounded-lg p-3 flex justify-between items-center">
              <div>
                <h6 className="font-semibold text-gray-900">Rent Car</h6>
                <p className="text-sm text-gray-600">Daniel Mananta • Toyota Alphard</p>
              </div>
              <span className="text-xs bg-gray-100 px-2 py-1 rounded-full">...</span>
            </div>
            <div className="bg-orange-100 rounded-lg p-3 flex justify-between items-center">
              <div>
                <h6 className="font-semibold text-gray-900">Eastern Bali Tour [B]</h6>
                <p className="text-sm text-gray-600">Anngela</p>
              </div>
              <span className="text-xs bg-gray-100 px-2 py-1 rounded-full">...</span>
            </div>
            <div className="bg-orange-100 rounded-lg p-3 flex justify-between items-center">
              <div>
                <h6 className="font-semibold text-gray-900">Eastern Bali Tour [B]</h6>
                <p className="text-sm text-gray-600">Anne Hathaway</p>
              </div>
              <span className="text-xs bg-gray-100 px-2 py-1 rounded-full">...</span>
            </div>
            <div className="bg-orange-100 rounded-lg p-3 flex justify-between items-center">
              <div>
                <h6 className="font-semibold text-gray-900">Eastern Bali Tour [B]</h6>
                <p className="text-sm text-gray-600">Carlos Quiros</p>
              </div>
              <span className="text-xs bg-gray-100 px-2 py-1 rounded-full">...</span>
            </div>
            <div className="bg-orange-100 rounded-lg p-3 flex justify-between items-center">
