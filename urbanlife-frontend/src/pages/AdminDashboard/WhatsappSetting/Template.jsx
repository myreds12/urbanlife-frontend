      ...
      <div className="bg-white rounded-xl shadow overflow-hidden">
        ...
        <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="text-sm text-gray-700 darksubtitle">
            ...
            {Math.min(startIndex + itemsPerPage, filteredTemplates.length)} of{" "}
          ...
          <div className="p-5">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600 darksubtitle">
                Buat notifikasi yang jelas dan personal pake data customer dan
                detail pemesanan
              </p>
            </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        <strong>Nama Customer</strong> - biar personal
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <i className="fa-solid fa-box text-blue-500"></i>
                      <span>
                        <strong>Detail Pemesanan</strong> - daftar item kayak
                        mobil atau hotel
                      </span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        <strong>Total Harga</strong> - total biaya pemesanan
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <i className="fa-solid fa-calendar text-blue-500"></i>
                      <span>
                        <strong>Tanggal Order</strong> - kapan pesanan dibuat
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-6 bg-gray-50 darkcard rounded-lg p-4">
              ...
              <div className="space-y-3 text-sm text-gray-700 darksubtitle">
                <div className="grid grid-cols-2 gap-3">
                  {/* Menampilkan message dengan HTML dari backend */}
                  ...
                  <div>
                    ...
                    • Mobil Avanza
                    <br />
                    • Hotel Urban - Deluxe Room
                    <br />
                    <br />
                    Total pembayaran: IDR 2.000.000
                    <br />
